...
```{r}
milw <- milw |> 
  mutate(defendant_address2 = defendant_address) |> 
...
Categorize the following as "berrada" properties "luther haven llc" "willow court apartments llc" "garden terrace homes llc" "good hope townhomes ii llc" "good hope townhomes llc" "colonial pointe ii apartments llc" "colonial pointe il apartments llc" "colonial pointe i apartments llc"

Categorize the following as "anchor_properties" "atlantis properties llc" "anchor properties llc" "action properties llc" "afc properties llc" "atunna properties llc" "affordable properties llc" "acme properties llc"
