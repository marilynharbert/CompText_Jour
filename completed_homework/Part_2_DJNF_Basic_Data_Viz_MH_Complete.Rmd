...
**Filter the dataset above and build a chart in one code block**
...
highest_call_day <- SF_call_dates %>%
  filter(n==232)

print(highest_call_day$call_date)
...
```{r}
ppp_maryland <- read_csv("/Users/marilynharbert/Code/CompText_Jour/03_tutorials/qmd_files/assets/data/ppp_loans_md.csv.zip")
```
